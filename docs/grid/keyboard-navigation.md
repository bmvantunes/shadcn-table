...
It passes feature owners a key- and modifier-free gesture capability containing only command
effects and ownership evidence. The build guard maintains an explicit finite map from exact
